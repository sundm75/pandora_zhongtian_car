...
void motor_ctl (int argc, char** argv)
{
    ...
    function_turn_left_mid(speed);      rt_thread_delay( RT_TICK_PER_SECOND/2 );
    function_turn_right_mid(speed);     rt_thread_delay( RT_TICK_PER_SECOND/2 );    
    function_turn_left_down(speed);     rt_thread_delay( RT_TICK_PER_SECOND/2 );
    function_turn_right_down(speed);    rt_thread_delay( RT_TICK_PER_SECOND/2 );
    function_stop4();
}
